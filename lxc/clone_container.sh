...
mkdir -p /container/$CONTAINER2/rootfs/media/sf_stagefiles
...
lxc.mount.entry=/media/sf_stagefiles /container/$CONTAINER2/rootfs/media/sf_stagefiles none rw,bind 0 0
EOF
